...
if [ $__AS != 0 ]; then
    ...
    __AF_error92_v0__9_9="$__AF_error92_v0"
    echo "$__AF_error92_v0__9_9" >/dev/null 2>&1
fi
...
echo_success__90_v0 "${image} server has started on 8088"
__AF_echo_success90_v0__14_5="$__AF_echo_success90_v0"
echo "$__AF_echo_success90_v0__14_5" >/dev/null 2>&1
